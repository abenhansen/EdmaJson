 ...
 */
public class ColorImpl extends Color implements IValueInstance
{
    ...
    /**
     * Compare this Color to another Color
     * @param color  The Color to compare with
     * @return       A negative integer, zero, or a positive integer as this
     *               Color is less than, equal to, or greater than the specified
     *               Color
     */
    public int compareTo(Color color)
    {
        return edma_domain.valueCompare(value, ((ColorImpl) color).value);
    }
