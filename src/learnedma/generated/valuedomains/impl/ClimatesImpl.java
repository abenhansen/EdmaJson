...
/**
 * The implementation of Climates
 */
public class ClimatesImpl extends Climates implements IValueInstance
{
    ...
    /**
     * Compare this Climates to another Climates
     * @param climates  The Climates to compare with
     * @return          A negative integer, zero, or a positive integer as this
     *                  Climates is less than, equal to, or greater than the
     *                  specified Climates
     */
    public int compareTo(Climates climates)
    {
        return edma_domain.valueCompare(value, ((ClimatesImpl) climates).value);
    }
     ...
     */
    public Iterator<Climate> iterator()
    {
        return new ClimatesIterator();
    }
     ...
     */
    public Climate get(int index)
    {
        return new ClimateImpl(value[index]);
    }
     ...
     * 
     */
    public class ClimatesIterator implements Iterator<Climate>
    {
        private int pos;
        ...
        public Climate next()
        {
            return new ClimateImpl(value[pos++]);
        }
