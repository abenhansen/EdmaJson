 ...
 */
public class ClimateImpl extends Climate implements IValueInstance
{
     ...
     */
    public ClimateImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this Climate to another Climate
     * @param climate  The Climate to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 Climate is less than, equal to, or greater than the
     *                 specified Climate
     */
    public int compareTo(Climate climate)
    {
        return edma_domain.valueCompare(value, ((ClimateImpl) climate).value);
    }
