 ...
 */
public class WeightImpl extends Weight implements IValueInstance
{
     ...
     */
    public WeightImpl(Object value)
    {
        this.value = value;
    }
     ...
     * @param weight  The Weight to compare with
     * @return        A negative integer, zero, or a positive integer as this
     *                Weight is less than, equal to, or greater than the
     *                specified Weight
     */
    public int compareTo(Weight weight)
    {
        return edma_domain.valueCompare(value, ((WeightImpl) weight).value);
    }
