 ...
 */
public class SpeciesImpl extends Species implements IValueInstance
{
     ...
     */
    public SpeciesImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this Species to another Species
     * @param species  The Species to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 Species is less than, equal to, or greater than the
     *                 specified Species
     */
    public int compareTo(Species species)
    {
        return edma_domain.valueCompare(value, ((SpeciesImpl) species).value);
    }
