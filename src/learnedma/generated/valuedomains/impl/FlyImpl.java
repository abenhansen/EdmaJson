...
/**
 * The implementation of Fly
 */
public class FlyImpl extends Fly implements IValueInstance
{
    ...
    /**
     * Compare this Fly to another Fly
     * @param fly  The Fly to compare with
     * @return     A negative integer, zero, or a positive integer as this Fly
     *             is less than, equal to, or greater than the specified Fly
     */
    public int compareTo(Fly fly)
    {
        return edma_domain.valueCompare(value, ((FlyImpl) fly).value);
    }
