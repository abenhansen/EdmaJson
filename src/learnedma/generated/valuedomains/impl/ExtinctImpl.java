...
/**
 * The implementation of Extinct
 */
public class ExtinctImpl extends Extinct implements IValueInstance
{
     ...
     */
    public ExtinctImpl(Object value)
    {
        this.value = value;
    }
    ...
    /**
     * Compare this Extinct to another Extinct
     * @param extinct  The Extinct to compare with
     * @return         A negative integer, zero, or a positive integer as this
     *                 Extinct is less than, equal to, or greater than the
     *                 specified Extinct
     */
    public int compareTo(Extinct extinct)
    {
        return edma_domain.valueCompare(value, ((ExtinctImpl) extinct).value);
    }
